...
export const getStaticPaths = async () => {
  return {
    ...
    // fallback：存在しないページへのアクセスがあったときにどうするか？
    // "true"の場合：上記のpathsで指定した以外のページを表示しようとすると、情報がなくても新しくページを作ってしまう
    // "false"の場合：上記のpathsで指定した以外のページを表示しようとすると「404」が表示される
    // "blocking"の場合：fallback
    fallback: "blocking",
  };
};
